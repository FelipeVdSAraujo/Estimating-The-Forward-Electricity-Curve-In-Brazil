...
sensitivity.prettyPlot(lambdaAlphaBuyer.sensiMatrix, xlabel=expression(paste("Buyer ", alpha, 1)), ylim=c(170, 205), ncol=2, cex=1.4, lwd=3, legendTitle=expression(paste("Buyer ", lambda, 1)))
...
#### Sensitivity for Risk-Free Rate on ECP WITH DATA FROM JANUARY A2 ####  
...
sensitivity.prettyPlot(rates.sensitivity.matrix, ylim=c(0, 205), ncol=5, cex=1.4, lwd=3, legendTitle="Risk-Free Rate aa.")
