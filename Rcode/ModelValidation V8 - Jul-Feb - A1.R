...
resultMatrix = rbind(spotPrices, forwardPrices, averagePrices, modelError, buyer.phi, seller.phi)
...
# Plotting area plot with plotly
require(plotly)
...
# The following line must be executed outside of Sourcing
#fig
